  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 flex flex-col items-center text-center"
      >
        ...
        >
          ...
          >
            <Link href="/download">
              ...
              <div className="ml-2 px-1.5 py-0.5 rounded-md bg-white/20 text-[10px] font-bold">
                DMG
              </div>
            </Link>
          </Button>
          <Button
            variant="outline"
            size="xl"
            className="rounded-full px-10 border-white/20 hover:bg-white/10 transition-all group"
            asChild
          >
            <Link href="/#pricing">
        ...
        >
          {[
            ...
            <div
              key={idx}
              className="flex flex-col items-center gap-3 p-4 rounded-3xl bg-white/[0.03] border border-white/10 hover:bg-white/[0.06] transition-all group cursor-default border-flow"
            >
              <div
      ...
      <motion.div
        ...
        className="relative z-20 w-full max-w-6xl px-4 mt-20"
      >
                ...
                <div className="space-y-2">
                  {[
                    ...
                    >
                      ...
                      <kbd className="text-[9px] font-mono text-[--color-text-muted] bg-white/5 px-1.5 py-0.5 rounded border border-white/5">
                        {item.key}
                      </kbd>
                    </div>
                  ))}
