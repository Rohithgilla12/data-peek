...
![AI Assistant generating SQL queries](https://pub-84538e6ab6f94b80b94b8aa308ad1270.r2.dev/ai-assitant-2.png)
...
![AI generating charts and metrics](https://pub-84538e6ab6f94b80b94b8aa308ad1270.r2.dev/ai-assitant.png)
...
- **Schema context**: Only schema metadata (table/column names) is sent to the AI, not your actual data
