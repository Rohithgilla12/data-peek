...
/**
 * AI configuration - simplified to Claude (Anthropic) only.
 * Users provide their Anthropic API key for local access.
 */
...
/**
 * Claude model information for UI display
 */
...
/**
 * Result from a chat request - includes streamed text and optional structured data
 */
export interface AIChatResult {
  /** Text content streamed during response */
  text: string;
  /** Structured response from tool use, if any */
