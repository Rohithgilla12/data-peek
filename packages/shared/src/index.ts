...
export { escapeSQLValue, escapeSQLIdentifier, isSQLKeyword, type SQLDialect } from './sql-escape'
 ...
 */
export type CreateDashboardInput = Omit<Dashboard, 'id' | 'createdAt' | 'updatedAt' | 'version'>
